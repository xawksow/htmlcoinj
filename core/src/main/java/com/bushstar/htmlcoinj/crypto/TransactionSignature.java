...
/**
 * A TransactionSignature wraps an {@link com.matthewmitchell.htmlcoinj.core.ECKey.ECDSASignature} and adds methods for handling
...
public class TransactionSignature extends ECKey.ECDSASignature {
     ...
     * and generally violates people's mental model of how HTMLcoin should work, thus, non-canonical signatures are now
     * not relayed by default.
     */
    public static boolean isEncodingCanonical(byte[] signature) {
        // See reference client's IsCanonicalSignature, https://htmlcointalk.org/index.php?topic=8392.msg127623#msg127623
     ...
     * of the type used by HTMLcoin we have to encode them using DER encoding, which is just a way to pack the two
     * components into a structure, and then we append a byte to the end for the sighash flags.
     */
    public byte[] encodeToHTMLcoin() {
        try {
     ...
     */
    public static TransactionSignature decodeFromHTMLcoin(byte[] bytes, boolean requireCanonical) throws VerificationException {
        // HTMLcoin encoding is DER signature + sighash byte.
        ...
        // In HTMLcoin, any value of the final byte is valid, but not necessarily canonical. See javadocs for
