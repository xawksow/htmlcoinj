...
public class TransactionInput extends ChildMessage implements Serializable {
     ...
     * "from address" is not well defined in HTMLcoin and you should not assume that senders of a transaction can
     ...
     * in nodes memory pools if the existing version is time locked. See the Contracts page on the HTMLcoin wiki for
