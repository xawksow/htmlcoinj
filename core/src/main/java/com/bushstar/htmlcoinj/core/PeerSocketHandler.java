...
import com.bushstar.htmlcoinj.net.AbstractTimeoutHandler;
import com.bushstar.htmlcoinj.net.MessageWriteTarget;
import com.bushstar.htmlcoinj.net.StreamParser;
...
public abstract class PeerSocketHandler extends AbstractTimeoutHandler implements StreamParser {
    ...
    private HTMLcoinSerializer.HTMLcoinPacketHeader header;
    ...
    public PeerSocketHandler(NetworkParameters params, InetSocketAddress remoteIp) {
        serializer = new HTMLcoinSerializer(checkNotNull(params));
    ...
    public int receiveBytes(ByteBuffer buff) {
        checkArgument(buff.position() == 0 &&
                buff.capacity() >= HTMLcoinSerializer.HTMLcoinPacketHeader.HEADER_LENGTH + 4);
        try {
     ...
     * called automatically by {@link com.bushstar.htmlcoinj.net.NioClient} or
     * {@link com.bushstar.htmlcoinj.net.NioClientManager} once the socket finishes initialization.
     */
    @Override
