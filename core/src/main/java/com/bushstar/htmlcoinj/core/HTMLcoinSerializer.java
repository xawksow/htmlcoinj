...
public class HTMLcoinSerializer {
    private static final Logger log = LoggerFactory.getLogger(HTMLcoinSerializer.class);
    ...
    /**
     * Constructs a HTMLcoinSerializer with the given behavior.
     *
     * @param params           networkParams used to create Messages instances and termining packetMagic
     */
    public HTMLcoinSerializer(NetworkParameters params) {
     ...
     */
    public HTMLcoinSerializer(NetworkParameters params, boolean parseLazy, boolean parseRetain) {
        this.params = params;
    ...
    public Message deserialize(ByteBuffer in) throws ProtocolException, IOException {
        // A HTMLcoin protocol message has the following format.
        //
        ...
        HTMLcoinPacketHeader header = new HTMLcoinPacketHeader(in);
     ...
     */
    public HTMLcoinPacketHeader deserializeHeader(ByteBuffer in) throws ProtocolException, IOException {
        return new HTMLcoinPacketHeader(in);
    }

    /**
     * Deserialize payload only.  You must provide a header, typically obtained by calling
     * {@link HTMLcoinSerializer#deserializeHeader}.
     */
    public Message deserializePayload(HTMLcoinPacketHeader header, ByteBuffer in) throws ProtocolException, BufferUnderflowException {
    ...
    public static class HTMLcoinPacketHeader {
        ...
        public HTMLcoinPacketHeader(ByteBuffer in) throws ProtocolException, BufferUnderflowException {
