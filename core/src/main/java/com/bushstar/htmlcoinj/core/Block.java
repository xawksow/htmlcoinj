...
public class Block extends Message {
     ...
     * upgrade everyone to change this, so HTMLcoin can continue to grow. For now it exists as an anti-DoS measure to
    ...
    /** Constructs a block object from the HTMLcoin wire format. */
    ...
    /**
     * Contruct a block object from the HTMLcoin wire format.
    ...
    /**
     * <p>A utility method that calculates how much new HTMLcoin would be created by the block at the given height.
     * The inflation of HTMLcoin is predictable and drops roughly every 4 years (210,000 blocks). At the dawn of
    ...
    /** Returns the version of the block data structure as defined by the HTMLcoin protocol. */
