...
public abstract class NetworkParameters implements Serializable {
     ...
     *
     * <p>The first block in every chain is a well known constant shared between all HTMLcoin implemenetations. For a
     ...
     * test and production HTMLcoin networks use 2 weeks (1209600 seconds).
     */
    ...
    /** How many blocks pass between difficulty adjustment periods. HTMLcoin standardises this to be 2015. */
