...
public class VersionMessage extends Message {
    ...
    public static final String HTMLcoinJ_VERSION = "0.11.3";
    /** The value that is prepended to the subVer field of this application. */
    public static final String LIBRARY_SUBVER = "/HTMLcoinJ:" + HTMLcoinJ_VERSION + "/";
     ...
     * name:version pairs separated by slashes in the form of a path. For example a typical subVer field for HTMLcoinJ
     * users might look like "/HTMLcoinJ:0.4-SNAPSHOT/MultiBit:1.2/" where libraries come further to the left.<p>
     *
