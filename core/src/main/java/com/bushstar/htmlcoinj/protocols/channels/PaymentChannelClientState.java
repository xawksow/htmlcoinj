...
import com.bushstar.htmlcoinj.wallet.AllowUnconfirmedCoinSelector;
 ...
 * <i>receiving party</i>. Although the underlying HTMLcoin protocol is capable of more complex relationships than that,
...
public class PaymentChannelClientState {
     ...
     * overriding {@link PaymentChannelClientState#editContractSendRequest(com.bushstar.htmlcoinj.core.Wallet.SendRequest)}.
    ...
    public synchronized void initiate() throws ValueOutOfRangeException, InsufficientMoneyException {
        ...
        // relies on the fact that since HTMLcoin 0.8 time locked transactions are non-final. This will need to change
    ...
    public synchronized void provideRefundSignature(byte[] theirSignature) throws VerificationException {
        ...
        TransactionSignature theirSig = TransactionSignature.decodeFromHTMLcoin(theirSignature, true);
