 ...
 *
 * <ul>
 * <li>A {@link HTMLcoinURI} object that conforms to BIP 0072</li>
 * <li>A url where the {@link Protos.PaymentRequest} can be fetched</li>
 * <li>Directly with a {@link Protos.PaymentRequest} object</li>
 * </ul>
 *
 * If initialized with a HTMLcoinURI or a url, a network request is made for the payment request object and a
...
public class PaymentSession {
     ...
     * uri is a BIP-72-style HTMLcoinURI object that specifies where the {@link Protos.PaymentRequest} object may
     ...
     */
    public static ListenableFuture<PaymentSession> createFromHTMLcoinUri(final HTMLcoinURI uri) throws PaymentRequestException {
        return createFromHTMLcoinUri(uri, true, null);
    }
     ...
     * signature cannot be verified.
     */
    public static ListenableFuture<PaymentSession> createFromHTMLcoinUri(final HTMLcoinURI uri, final boolean verifyPki)
            throws PaymentRequestException {
        return createFromHTMLcoinUri(uri, verifyPki, null);
    }
     ...
     */
    public static ListenableFuture<PaymentSession> createFromHTMLcoinUri(final HTMLcoinURI uri, final boolean verifyPki, @Nullable final String trustStorePath)
            throws PaymentRequestException {
        String url = uri.getPaymentRequestUrl();
        if (url == null)
            throw new PaymentRequestException.InvalidPaymentRequestURL("No payment request URL (r= parameter) in HTMLcoinURI " + uri);
        try {
